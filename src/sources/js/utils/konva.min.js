! function (t, e) {
    ...
    var t = function (t) {
        ...
        h = {},
        i = function (t) {
            h[t.prototype.getClassName()] = t, O[t.prototype.getClassName()] = t
        },
        a = function () {
            function r() {}
    ...
    a.prototype = [], a.prototype.each = function (t) {
    ...
    var d = function () {
        ...
        I = {
            ...
            colorToRGBA: function (t) {
                return t = t || "black", I._namedColorToRBA(t) || I._hex3ColorToRGBA(t) || I._hex6ColorToRGBA(t) || I._rgbColorToRGBA(t) || I._rgbaColorToRGBA(t) || I._hslColorToRGBA(t)
            },
            ...
            _expandPoints: function (t, e) {
                var i, n, r = t.length,
                    o = [];
                for (i = 2; i < r - 2; i += 2) n = I._getControlPoints(t[i - 2], t[i - 1], t[i], t[i + 1], t[i + 2], t[i + 3], e), o.push(n[0]), o.push(n[1]), o.push(t[i]), o.push(t[i + 1]), o.push(n[2]), o.push(n[3]);
                return o
            },
            each: function (t, e) {
            ...
            _getProjectionToLine: function (s, h, l) {
                var d = I.cloneObject(s),
                    c = Number.MAX_VALUE;
                return h.forEach(function (t, e) {
                    if (l || e !== h.length - 1) {
                        var i = h[(e + 1) % h.length],
                            n = I._getProjectionToSegment(t.x, t.y, i.x, i.y, s.x, s.y),
                            r = n[0],
                            o = n[1],
                            a = n[2];
                        a < c && (d.x = r, d.y = o, c = a)
            ...
            _prepareArrayForTween: function (t, e, i) {
                ...
                return o.forEach(function (t) {
                    var e = I._getProjectionToLine(t, r, i);
            ...
            _prepareToStringify: function (t) {
                ...
                for (var i in t.visitedByCircularReferenceRemoval = !0, t)
                    if (t.hasOwnProperty(i) && t[i] && "object" == typeof t[i])
                        if (e = Object.getOwnPropertyDescriptor(t, i), t[i].visitedByCircularReferenceRemoval || I._isElement(t[i])) {
                            if (!e.configurable) return null;
                            delete t[i]
                        } else if (null === I._prepareToStringify(t[i])) {
                    if (!e.configurable) return null;
                    delete t[i]
                }
    ...
    function u(t) {
        return I._isString(t) ? '"' + t + '"' : "[object Number]" === Object.prototype.toString.call(t) ? t : I._isBoolean(t) ? t : Object.prototype.toString.call(t)
    }
    ...
    function g() {
        if (O.isUnminified) return function (t, e) {
            return I._isNumber(t) || I.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a number.'), t
        }
    }

    function v() {
        if (O.isUnminified) return function (t, e) {
            return I._isNumber(t) || "auto" === t || I.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a number or "auto".'), t
        }
    }

    function y() {
        if (O.isUnminified) return function (t, e) {
            return I._isString(t) || I.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a string.'), t
        }
    }

    function m() {
        if (O.isUnminified) return function (t, e) {
            return !0 === t || !1 === t || I.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a boolean.'), t
        }
    }
    var _ = "get",
        S = "set",
        b = {
            ...
            addSetter: function (t, e, i, n) {
                var r = S + I._capitalize(e);
                t.prototype[r] || b.overWriteSetter(t, e, i, n)
            },
            ...
            addComponentsGetterSetter: function (t, n, e, r, o) {
                ...
                var c = function (i) {
                    if (O.isUnminified) return function (t, e) {
                        return I.isObject(t) || I.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be an object with properties ' + i), t
                    }
                }(e);
            ...
            addDeprecatedGetterSetter: function (t, e, i, n) {
                I.error("Adding deprecated " + e);
                var r = _ + I._capitalize(e),
            ...
            backCompat: function (a, t) {
                I.each(t, function (t, e) {
                    ...
                    function o() {
                        i.apply(this, arguments), I.error('"' + t + '" method is deprecated and will be removed soon. Use ""' + e + '" instead.')
                    }
        ...
        P = function () {
            ...
            return t.prototype.fillShape = function (t) {
                ...
                var e, i, n, r, o = this.traceArr,
                    a = o.length,
                    s = "";
                for (e = 0; e < a; e++)(n = (i = o[e]).method) ? (r = i.args, s += n, t ? s += "()" : I._isArray(r[0]) ? s += "([" + r.join(",") + "])" : s += "(" + r.join(",") + ")") : (s += i.property, t || (s += "=" + i.val)), s += ";";
                return s
            ...
            }, t.prototype.arcTo = function (t, e, i, n, r, o) {
                this._context.arc(t, e, i, n, r, o)
    ...
    var k, T = function (t) {
            ...
            return w(e, t), e.prototype._fillColor = function (t) {
                var e = t.fill();
                ...
                var e = t.getFillPatternX(),
                    ...
                    o = O.getAngle(t.getFillPatternRotation()),
                    a = t.getFillPatternOffsetX(),
                    s = t.getFillPatternOffsetY();
                (e || i) && this.translate(e || 0, i || 0), o && this.rotate(o), (n || r) && this.scale(n, r), (a || s) && this.translate(-1 * a, -1 * s), this.setAttr("fillStyle", t._getFillPattern()), t._fillFunc(this)
        ...
        M = function (t) {
            ...
            return w(e, t), e.prototype._fill = function (t) {
    ...
    var A = function () {
        function t(t) {
            ...
            var e = (t || {}).pixelRatio || O.pixelRatio || function () {
                if (k) return k;
                var t = I.createCanvasElement().getContext("2d");
                return k = (O._global.devicePixelRatio || 1) / (t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1)
            }();
            this.pixelRatio = e, this._canvas = I.createCanvasElement(), this._canvas.style.padding = "0", this._canvas.style.margin = "0", this._canvas.style.border = "0", this._canvas.style.background = "transparent", this._canvas.style.position = "absolute", this._canvas.style.top = "0", this._canvas.style.left = "0"
        }
        return t.prototype.getContext = function () {
            ...
            try {
                ...
                try {
                    ...
                    return I.error("Unable to get data URL. " + t.message), ""
                }
            }
        }, t
    }();
    b.addGetterSetter(A, "pixelRatio", void 0, g());
    var G = function (i) {
            function t(t) {
                void 0 === t && (t = {
                    width: 0,
                ...
                return e.context = new T(e), e.setSize(t.width, t.height), e
            }
            return w(t, i), t
        }(A),
        R = function (i) {
            function t(t) {
                ...
                var e = i.call(this, t) || this;
                return e.hitCanvas = !0, e.context = new M(e), e.setSize(t.width, t.height), e
            }
            return w(t, i), t
        }(A),
        L = {
            get isDragging() {
                var e = !1;
                return L._dragElements.forEach(function (t) {
                    t.isDragging && (e = !0)
                }), e
            },
            justDragged: !1,
            ...
            _drag: function (a) {
                L._dragElements.forEach(function (e, t) {
                    var i = e.node,
                        n = i.getStage();
                    n.setPointersPositions(a), void 0 === e.pointerId && (e.pointerId = I._getFirstPointerId(a));
                    ...
                    if (r) {
                        if (!e.isDragging) {
                            ...
                            if (e.isDragging = !0, i.fire("dragstart", {
                                    type: "dragstart",
                                    target: i,
                                    evt: a
            ...
            _endDragBefore: function (r) {
                L._dragElements.forEach(function (e, t) {
                    ...
                    if (i.setPointersPositions(r), i._changedPointerPositions.find(function (t) {
                            return t.id === e.pointerId
                        })) {
                        e.isDragging && (L.justDragged = !0, O.listenClickTap = !1), e.dragStopped = !0, e.isDragging = !1;
            ...
            _endDragAfter: function (i) {
                L._dragElements.forEach(function (t, e) {
                    t.dragStopped && (t.node.fire("dragend", {
                        type: "dragend",
                        target: t.node,
                        evt: i
                    }, !0), L._dragElements.delete(e))
                })
            }
        };
    O.isBrowser && (window.addEventListener("mouseup", L._endDragBefore, !0), window.addEventListener("touchend", L._endDragBefore, !0), window.addEventListener("mousemove", L._drag), window.addEventListener("touchmove", L._drag), window.addEventListener("mouseup", L._endDragAfter, !1), window.addEventListener("touchend", L._endDragAfter, !1));
    var D = {},
        E = {},
        F = function (t, e) {
            t && D[t] === e && delete D[t]
        ...
        q = "visible",
        V = ["id"],
        K = ["xChange.konva", "yChange.konva", "scaleXChange.konva", "scaleYChange.konva", "skewXChange.konva", "skewYChange.konva", "rotationChange.konva", "offsetXChange.konva", "offsetYChange.konva", "transformsEnabledChange.konva"].join(" "),
        Q = ["scaleXChange.konva", "scaleYChange.konva"].join(" "),
        J = new a,
        Z = 1,
        $ = function () {
            function s(t) {
                var e = this;
                this._id = Z++, this.eventListeners = {}, this.attrs = {}, this.index = 0, this.parent = null, this._cache = new Map, this._lastPos = null, this._filterUpToDate = !1, this._isUnderCache = !1, this.children = J, this._dragEventId = null, this.setAttrs(t), this.on(K, function () {
                    e._clearCache(U), e._clearSelfAndDescendantCache(W)
                }), this.on(Q, function () {
                    e._clearSelfAndDescendantCache(N)
                }), this.on("visibleChange.konva", function () {
                    e._clearSelfAndDescendantCache(q)
                }), this.on("listeningChange.konva", function () {
                    e._clearSelfAndDescendantCache(Y)
            ...
            return s.prototype.hasChildren = function () {
                ...
                this._clearCache(e), this._getCanvasCache() || this.children && this.children.each(function (t) {
                    t._clearSelfAndDescendantCache(e)
                })
            }, s.prototype.clearCache = function () {
                return this._cache.delete(H), this._clearSelfAndDescendantCache(), this
                ...
                if (n && r) {
                    ...
                    var d = new G({
                        ...
                        u = d.getContext(),
                        f = p.getContext();
                    return p.isCache = !0, this._cache.delete("canvas"), (this._filterUpToDate = !1) === e.imageSmoothingEnabled && (d.getContext()._context.imageSmoothingEnabled = !1, c.getContext()._context.imageSmoothingEnabled = !1, p.getContext()._context.imageSmoothingEnabled = !1), u.save(), f.save(), u.translate(-a, -s), f.translate(-a, -s), this._isUnderCache = !0, this._clearSelfAndDescendantCache(z), this._clearSelfAndDescendantCache(N), this.drawScene(d, this, !0), this.drawHit(p, this, !0), this._isUnderCache = !1, u.restore(), f.restore(), l && (u.save(), u.beginPath(), u.rect(0, 0, n, r), u.closePath(), u.setAttr("strokeStyle", "red"), u.setAttr("lineWidth", 5), u.stroke(), u.restore()), this._cache.set(H, {
                        scene: d,
                        filter: c,
                        hit: p,
                        x: a,
                ...
                I.error("Can not cache the node. Width or height of the node equals 0. Caching is skipped.")
                ...
                var e = this._getCanvasCache(),
                    i = e.hit;
                t.save(), t._applyGlobalCompositeOperation(this), t.translate(e.x, e.y), t.drawImage(i._canvas, 0, 0), t.restore()
                ...
                if (r) {
                    if (!this._filterUpToDate) {
                        var l = a.pixelRatio;
                        try {
                            for (t = r.length, h.clear(), h.drawImage(a._canvas, 0, 0, a.getWidth() / l, a.getHeight() / l), e = h.getImageData(0, 0, s.getWidth(), s.getHeight()), i = 0; i < t; i++) "function" == typeof (n = r[i]) ? (n.call(this, e), h.putImageData(e, 0, 0)) : I.error("Filter should be type of function, but got " + typeof n + " insted. Please check correct filters")
                        } catch (t) {
                            I.error("Unable to apply filter. " + t.message)
                        }
                ...
                this.on(t, function (t) {
                    for (var e = t.target.findAncestors(n, !0, o), i = 0; i < e.length; i++)(t = I.cloneObject(t)).currentTarget = e[i], r.call(e[i], t)
                })
            }, s.prototype.remove = function () {
                return this.isDragging() && this.stopDrag(), L._dragElements.delete(this._id), this._remove(), this
            }, s.prototype._remove = function () {
                this._clearSelfAndDescendantCache("stage"), this._clearSelfAndDescendantCache(W), this._clearSelfAndDescendantCache(q), this._clearSelfAndDescendantCache(Y), this._clearSelfAndDescendantCache(z);
                ...
                var e = "get" + I._capitalize(t);
                return I._isFunction(this[e]) ? this[e]() : this.attrs[t]
            }, s.prototype.getAncestors = function () {
                for (var t = this.getParent(), e = new a; t;) e.push(t), t = t.getParent();
                return e
                ...
                var e, i;
                if (!t) return this;
                for (e in t) "children" !== e && (i = "set" + I._capitalize(e), I._isFunction(this[i]) ? this[i](t[e]) : this._setAttr(e, t[e]));
                return this
            }, s.prototype.isListening = function () {
                return this._getCache(Y, this._isListening)
                ...
                this._clearCache(U), this._clearSelfAndDescendantCache(W)
                ...
                return this.attrs.x = 0, this.attrs.y = 0, this.attrs.rotation = 0, this.attrs.scaleX = 1, this.attrs.scaleY = 1, this.attrs.offsetX = 0, this.attrs.offsetY = 0, this.attrs.skewX = 0, this.attrs.skewY = 0, this._clearCache(U), this._clearSelfAndDescendantCache(W), t
                ...
                if (!this.parent) return I.warn("Node has no parent. moveToTop function is ignored."), !1;
                var t = this.index;
                ...
                if (!this.parent) return I.warn("Node has no parent. moveUp function is ignored."), !1;
                var t = this.index;
                ...
                if (!this.parent) return I.warn("Node has no parent. moveDown function is ignored."), !1;
                var t = this.index;
                ...
                if (!this.parent) return I.warn("Node has no parent. moveToBottom function is ignored."), !1;
                var t = this.index;
                ...
                if (!this.parent) return I.warn("Node has no parent. zIndex parameter is ignored."), this;
                (t < 0 || t >= this.parent.children.length) && I.warn("Unexpected value " + t + " for zIndex property. zIndex is just index of a node in children of its parent. Expected value is from 0 to " + (this.parent.children.length - 1) + ".");
                var e = this.index;
                ...
                var t, e, i, n = {},
                    r = this.getAttrs();
                for (t in n.attrs = {}, r) e = r[t], I.isObject(e) && !I._isPlainObject(e) && !I._isArray(e) || (i = "function" == typeof this[t] && this[t], delete r[t], (i ? i.call(this) : null) !== (r[t] = e) && (n.attrs[t] = e));
                return n.className = this.getClassName(), I._prepareToStringify(n)
                ...
                var e, i, n = t.replace(/ /g, "").split(","),
                    r = n.length;
                for (e = 0; e < r; e++)
                    if (i = n[e], I.isValidSelector(i) || (I.warn('Selector "' + i + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), I.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), I.warn("Konva is awesome, right?")), "#" === i.charAt(0)) {
                ...
                return t ? this._getAbsoluteTransform(t) : this._getCache(W, this._getAbsoluteTransform)
                ...
                return t ? this._getAbsoluteScale(t) : this._getCache(N, this._getAbsoluteScale)
                ...
                var e, i, n, r, o, a = I.cloneObject(this.attrs);
                for (var s in V) {
                    delete a[V[s]]
                }
                for (e in t) a[e] = t[e];
                ...
                for (e in this.eventListeners)
                    for (n = (i = this.eventListeners[e]).length, r = 0; r < n; r++)(o = i[r]).name.indexOf("konva") < 0 && (h.eventListeners[e] || (h.eventListeners[e] = []), h.eventListeners[e].push(o));
                return h
                ...
                var e = t.callback;
                delete t.callback, I._urlToImage(this.toDataURL(t), function (t) {
                    e(t)
                })
                ...
                var e, i, n, r, o = (this.name() || "").split(/\s/g),
                    a = (t || "").split(/\s/g);
                for (i = 0; i < o.length; i++) e = o[i], -1 === a.indexOf(e) && e && B(e, this._id);
                for (i = 0; i < a.length; i++) e = a[i], -1 === o.indexOf(e) && e && (n = this, (r = e) && (E[r] || (E[r] = []), E[r].push(n)));
                ...
                var i = this["set" + I._capitalize(t)];
                return I._isFunction(i) ? i.call(this, e) : this._setAttr(t, e), this
            }, s.prototype._setAttr = function (t, e) {
                var i = this.attrs[t];
                (i !== e || I.isObject(e)) && (null == e ? delete this.attrs[t] : this.attrs[t] = e, this._fireChangeEvent(t, i, e))
                ...
                if (e && "Shape" === this.nodeType && (e.target = this), !((t === X || t === j) && (i && (this === i || this.isAncestorOf && this.isAncestorOf(i)) || "Stage" === this.nodeType && !i))) {
                    this._fire(t, e);
                    var n = (t === X || t === j) && i && i.isAncestorOf && i.isAncestorOf(this) && !i.isAncestorOf(this.parent);
            ...
            }, s.prototype.startDrag = function (t) {
                var e = t ? t.pointerId : void 0,
                    i = this.getStage()._getPointerById(e),
                    n = this.getAbsolutePosition();
                i && L._dragElements.set(this._id, {
                    node: this,
                    startPointerPos: i,
                    offset: {
                        x: i.x - n.x,
            ...
            }, s.prototype._setDragPosition = function (t, e) {
                ...
                if (i) {
                    ...
                    void 0 !== n && (r = n.call(this, r, t)), this._lastPos && this._lastPos.x === r.x && this._lastPos.y === r.y || (this.setAbsolutePosition(r), this.getLayer() ? this.getLayer().batchDraw() : this.getStage() && this.getStage().batchDraw()), this._lastPos = r
                }
            }, s.prototype.stopDrag = function () {
                var t = {};
                L._dragElements.get(this._id).dragStopped = !0, L._endDragBefore(t), L._endDragAfter(t)
            }, s.prototype.setDraggable = function (t) {
                this._setAttr("draggable", t), this._dragChange()
            }, s.prototype.isDragging = function () {
                var t = L._dragElements.get(this._id);
                ...
                this._dragCleanup(), this.on("mousedown.konva touchstart.konva", function (t) {
                    (!(void 0 !== t.evt.button) || 0 <= O.dragButtons.indexOf(t.evt.button)) && (this.isDragging() || this.startDrag(t))
                })
            }, s.prototype._dragChange = function () {
                this.attrs.draggable ? this._listenDrag() : (this._dragCleanup(), this.getStage() && L._dragElements.has(this._id) && this.stopDrag())
            }, s.prototype._dragCleanup = function () {
                this.off("mousedown.konva"), this.off("touchstart.konva")
            }, s.create = function (t, e) {
                return I._isString(t) && (t = JSON.parse(t)), this._createNode(t, e)
            }, s._createNode = function (t, e) {
                var i, n, r, o = s.prototype.getClassName.call(t),
                    a = t.children;
                if (e && (t.attrs.container = e), h[o] || (I.warn('Can not find a node with class name "' + o + '". Fallback to "Shape".'), o = "Shape"), i = new h[o](t.attrs), a)
                    for (n = a.length, r = 0; r < n; r++) i.add(s._createNode(a[r]));
                return i
            }, s
        }();
    $.prototype.nodeType = "Node", $.prototype._attrsAffectingSize = [], b.addGetterSetter($, "zIndex"), b.addGetterSetter($, "absolutePosition"), b.addGetterSetter($, "position"), b.addGetterSetter($, "x", 0, g()), b.addGetterSetter($, "y", 0, g()), b.addGetterSetter($, "globalCompositeOperation", "source-over", y()), b.addGetterSetter($, "opacity", 1, g()), b.addGetterSetter($, "name", "", y()), b.addGetterSetter($, "id", "", y()), b.addGetterSetter($, "rotation", 0, g()), b.addComponentsGetterSetter($, "scale", ["x", "y"]), b.addGetterSetter($, "scaleX", 1, g()), b.addGetterSetter($, "scaleY", 1, g()), b.addComponentsGetterSetter($, "skew", ["x", "y"]), b.addGetterSetter($, "skewX", 0, g()), b.addGetterSetter($, "skewY", 0, g()), b.addComponentsGetterSetter($, "offset", ["x", "y"]), b.addGetterSetter($, "offsetX", 0, g()), b.addGetterSetter($, "offsetY", 0, g()), b.addGetterSetter($, "dragDistance", null, g()), b.addGetterSetter($, "width", 0, g()), b.addGetterSetter($, "height", 0, g()), b.addGetterSetter($, "listening", "inherit", function (t) {
        return !0 === t || !1 === t || "inherit" === t || I.warn(t + ' is a not valid value for "listening" attribute. The value may be true, false or "inherit".'), t
    }), b.addGetterSetter($, "preventDefault", !0, m()), b.addGetterSetter($, "filters", null, function (t) {
        return this._filterUpToDate = !1, t
    }), b.addGetterSetter($, "visible", "inherit", function (t) {
        return !0 === t || !1 === t || "inherit" === t || I.warn(t + ' is a not valid value for "visible" attribute. The value may be true, false or "inherit".'), t
    }), b.addGetterSetter($, "transformsEnabled", "all", y()), b.addGetterSetter($, "size"), b.addGetterSetter($, "dragBoundFunc"), b.addGetterSetter($, "draggable", !1, m()), b.backCompat($, {
        rotateDeg: "rotate",
    ...
    var tt = function (e) {
        function t() {
            ...
            return t.children = new a, t
        }
        return w(t, e), t.prototype.getChildren = function (e) {
            ...
            return this.children = new a, this
            ...
            return this.hasChildren() && this.destroyChildren(), e.prototype.destroy.call(this), this
        }, t.prototype.find = function (t) {
            return this._generalFind(t, !1)
        }, t.prototype.get = function (t) {
            return I.warn("collection.get() method is deprecated. Please use collection.find() instead."), this.find(t)
            ...
            var t = $.prototype.toObject.call(this);
            t.children = [];
            ...
            var e = $.prototype.clone.call(this, t);
        ...
        }, t.prototype._drawChildren = function (e, i, n, r, o, t) {
            ...
            var e = this.getLayer(),
                i = !1;
            L._dragElements.forEach(function (t) {
                t.isDragging && t.node.getLayer() === e && (i = !0)
            });
    ...
    b.addComponentsGetterSetter(tt, "clip", ["x", "y", "width", "height"]), b.addGetterSetter(tt, "clipX", void 0, g()), b.addGetterSetter(tt, "clipY", void 0, g()), b.addGetterSetter(tt, "clipWidth", void 0, g()), b.addGetterSetter(tt, "clipHeight", void 0, g()), b.addGetterSetter(tt, "clipFunc"), a.mapMethods(tt);
    var et = new Map;
    ...
    function ot(t, e) {
        at(t), e.getStage() && (et.set(t, e), e._fire("gotpointercapture", nt(new PointerEvent("gotpointercapture"))))
    }
    ...
    function at(t, e) {
        ...
        if (i) {
            var n = i.getStage();
            n && n.content, et.delete(t), i._fire("lostpointercapture", nt(new PointerEvent("lostpointercapture")))
        }
    }
    var st = "mouseout",
        ht = "mouseleave",
        ...
        xt = "wheel",
        wt = "_",
        Ct = [dt, pt, ct, ut, st, _t, bt, St, lt, xt, yt, gt, ft, vt, "pointercancel", "lostpointercapture"],
        Pt = Ct.length;
    ...
    function Mt(t) {
        return void 0 === t && (t = {}), (t.clipFunc || t.clipWidth || t.clipHeight) && I.warn("Stage does not support clipping. Please use clip for Layers or Groups."), t
    }
    var At = function (n) {
        function t(t) {
            var e = n.call(this, Mt(t)) || this;
            return e._pointerPositions = [], e._changedPointerPositions = [], e._buildDOM(), e._bindContentEvents(), Tt.push(e), e.on("widthChange.konva heightChange.konva", e._resizeDOM), e.on("visibleChange.konva", e._checkVisibility), e.on("clipWidthChange.konva clipHeightChange.konva clipFuncChange.konva", function () {
                Mt(e.attrs)
            }), e._checkVisibility(), e
        }
        return w(t, n), t.prototype._validateAdd = function (t) {
            var e = "Layer" === t.getType(),
                i = "FastLayer" === t.getType();
            e || i || I.throw("You may only add layers to the stage.")
            ...
            return t || (t = {}), t.container = document.createElement("div"), tt.prototype.clone.call(this, t)
        }, t.prototype.destroy = function () {
            n.prototype.destroy.call(this);
            var t = this.content;
            t && I._isInDocument(t) && this.container().removeChild(t);
            var e = Tt.indexOf(this);
            return -1 < e && Tt.splice(e, 1), this
        }, t.prototype.getPointerPosition = function () {
            var t = this._pointerPositions[0];
            return t || I.warn("Pointer position is missing and not registered by the stage. Looks like it is outside of the stage container. You can set it manually from event: stage.setPointersPositions(event);"), {
                x: t.x,
                y: t.y
            }
        }, t.prototype._getPointerById = function (e) {
            return this._pointerPositions.find(function (t) {
                return t.id === e
            })
        }, t.prototype.getPointersPositions = function () {
            ...
            if (this.content) {
                var t, e, i = this.width(),
                    ...
                    r = this.getChildren(),
                    o = r.length;
                for (this.content.style.width = i + "px", this.content.style.height = n + "px", this.bufferCanvas.setSize(i, n), this.bufferHitCanvas.setSize(i, n), t = 0; t < o; t++)(e = r[t]).setSize({
                    width: i,
                    height: n
                }), e.draw()
            }
            ...
            return 5 < i && I.warn("The stage has " + i + " layers. Recommended maximin number of layers is 3-5. Adding more layers into the stage may drop the performance. Rethink your tree structure, you can use Konva.Group."), t._setCanvasSize(this.width(), this.height()), t.draw(), O.isBrowser && this.content.appendChild(t.canvas._canvas), this
        }, t.prototype.getParent = function () {
            return null
        }, t.prototype.getLayer = function () {
            return null
        }, t.prototype.hasPointerCapture = function (t) {
            return rt(t, this)
        }, t.prototype.setPointerCapture = function (t) {
            ot(t, this)
        }, t.prototype.releaseCapture = function (t) {
            at(t)
        }, t.prototype.getLayers = function () {
            return this.getChildren()
        }, t.prototype._bindContentEvents = function () {
            if (O.isBrowser)
                for (var t = 0; t < Pt; t++) kt(this, Ct[t])
        }, t.prototype._mouseenter = function (t) {
            this.setPointersPositions(t), this._fire(dt, {
                evt: t,
                target: this,
                currentTarget: this
            })
            ...
            e && !L.isDragging ? (e._fireAndBubble(st, {
                evt: t
            }), e._fireAndBubble(ht, {
                evt: t
            }), this.targetShape = null) : L.isDragging || (this._fire(ht, {
                evt: t,
                target: this,
                currentTarget: this
            }), this._fire(st, {
            ...
            this.setPointersPositions(t);
            var e, i = I._getFirstPointerId(t);
            if (!L.isDragging) {
                if ((e = this.getIntersection(this.getPointerPosition())) && e.isListening()) {
                    var n = !this.targetShape || this.targetShape !== e;
                    !L.isDragging && n ? (this.targetShape && (this.targetShape._fireAndBubble(st, {
                        evt: t,
                        pointerId: i
                    }, e), this.targetShape._fireAndBubble(ht, {
                        evt: t,
                        pointerId: i
                    }, e)), e._fireAndBubble(lt, {
                        evt: t,
                        pointerId: i
                    }, this.targetShape), e._fireAndBubble(dt, {
                        evt: t,
                        pointerId: i
                    }, this.targetShape), this.targetShape = e) : e._fireAndBubble(ct, {
                        evt: t,
                        pointerId: i
                    })
                } else this.targetShape && !L.isDragging && (this.targetShape._fireAndBubble(st, {
                    evt: t,
                    pointerId: i
                }), this.targetShape._fireAndBubble(ht, {
                    evt: t,
                    pointerId: i
                }), this._fire(lt, {
                    evt: t,
                    ...
                    currentTarget: this,
                    pointerId: i
                }), this.targetShape = null), this._fire(ct, {
                    evt: t,
                    target: this,
                    currentTarget: this,
                    pointerId: i
            ...
            this.setPointersPositions(t);
            var e = I._getFirstPointerId(t),
                i = this.getIntersection(this.getPointerPosition());
            O.listenClickTap = !0, i && i.isListening() ? (this.clickStartShape = i)._fireAndBubble(pt, {
                evt: t,
                pointerId: e
            }) : this._fire(pt, {
                evt: t,
            ...
            var e = I._getFirstPointerId(t),
                ...
                o = !1;
            O.inDblClickWindow ? (o = !0, clearTimeout(this.dblTimeout)) : L.justDragged ? L && (L.justDragged = !1) : (O.inDblClickWindow = !0, clearTimeout(this.dblTimeout)), this.dblTimeout = setTimeout(function () {
                O.inDblClickWindow = !1
            }, O.dblClickWindow), i && i.isListening() ? ((this.clickEndShape = i)._fireAndBubble(ut, {
                evt: t,
                pointerId: e
            }), O.listenClickTap && n && n._id === i._id && (i._fireAndBubble("click", {
                evt: t,
                pointerId: e
            }), o && r && r === i && i._fireAndBubble(mt, {
                evt: t,
                pointerId: e
            }))) : (this._fire(ut, {
                evt: t,
            ...
            e && e.isListening() ? e._fireAndBubble(yt, {
                evt: t
            }) : this._fire(yt, {
                evt: t,
                target: this,
        ...
        }, t.prototype._touchstart = function (i) {
            var n = this;
            this.setPointersPositions(i);
            var r = !1;
            this._changedPointerPositions.forEach(function (t) {
                var e = n.getIntersection(t);
                O.listenClickTap = !0, e && e.isListening() && (O.captureTouchEventsEnabled && e.setPointerCapture(t.id), (n.tapStartShape = e)._fireAndBubble(_t, {
                    evt: i,
                    pointerId: t.id
        ...
        }, t.prototype._touchmove = function (i) {
            var n = this;
            if (this.setPointersPositions(i), !L.isDragging || O.hitOnDragEnabled) {
                var r = !1,
                    o = {};
                this._changedPointerPositions.forEach(function (t) {
                    var e = it(t.id) || n.getIntersection(t);
                    e && e.isListening() && (o[e._id] || (o[e._id] = !0, e._fireAndBubble(bt, {
                        evt: i,
                        pointerId: t.id
            ...
            L.isDragging && L.node.preventDefault() && i.cancelable && i.preventDefault()
        }, t.prototype._touchend = function (i) {
            var n = this;
            this.setPointersPositions(i);
            var r = this.clickEndShape,
                o = !1;
            O.inDblClickWindow ? o = !0 : O.inDblClickWindow = !0, clearTimeout(this.dblTimeout), this.dblTimeout = setTimeout(function () {
                O.inDblClickWindow = !1
            }, O.dblClickWindow);
            var a = !1,
                s = {};
            this._changedPointerPositions.forEach(function (t) {
                var e = it(t.id) || n.getIntersection(t);
                e && e.releaseCapture(t.id), e && e.isListening() && (s[e._id] || (s[e._id] = !0, (n.clickEndShape = e)._fireAndBubble(St, {
                    evt: i,
                    pointerId: t.id
                }), a = !0, O.listenClickTap && n.tapStartShape && e._id === n.tapStartShape._id && (e._fireAndBubble("tap", {
                    evt: i,
                    pointerId: t.id
                }), o && r && r === e && e._fireAndBubble("dbltap", {
                    evt: i,
                    pointerId: t.id
                ...
                currentTarget: this,
                pointerId: this._changedPointerPositions[0].id
            }), O.listenClickTap && this._fire("tap", {
                evt: i,
                target: this,
                currentTarget: this,
                pointerId: this._changedPointerPositions[0].id
            ...
            this.setPointersPositions(t);
            var e = this.getIntersection(this.getPointerPosition());
            e && e.isListening() ? e._fireAndBubble(xt, {
                evt: t
            }) : this._fire(xt, {
                evt: t,
                target: this,
            ...
            if (O._pointerEventsEnabled) {
                this.setPointersPositions(t);
                var e = it(t.pointerId) || this.getIntersection(this.getPointerPosition());
                e && e._fireAndBubble(gt, nt(t))
            }
        }, t.prototype._pointermove = function (t) {
            if (O._pointerEventsEnabled) {
                this.setPointersPositions(t);
                var e = it(t.pointerId) || this.getIntersection(this.getPointerPosition());
                e && e._fireAndBubble(ft, nt(t))
            }
        }, t.prototype._pointerup = function (t) {
            if (O._pointerEventsEnabled) {
                this.setPointersPositions(t);
                var e = it(t.pointerId) || this.getIntersection(this.getPointerPosition());
                e && e._fireAndBubble(vt, nt(t)), at(t.pointerId)
            }
        }, t.prototype._pointercancel = function (t) {
            if (O._pointerEventsEnabled) {
                this.setPointersPositions(t);
                var e = it(t.pointerId) || this.getIntersection(this.getPointerPosition());
                e && e._fireAndBubble(vt, nt(t)), at(t.pointerId)
            }
        }, t.prototype._lostpointercapture = function (t) {
            at(t.pointerId)
            ...
            if (void 0 !== (t = t || window.event).touches) {
                if (this._pointerPositions = [], this._changedPointerPositions = [], a.prototype.each.call(t.touches, function (t) {
                        e._pointerPositions.push({
                            id: t.identifier,
                            x: t.clientX - i.left,
                            y: t.clientY - i.top
                        })
                    }), a.prototype.each.call(t.changedTouches || t.touches, function (t) {
                    ...
                    var o = t.touches[0];
                    n = o.clientX - i.left, r = o.clientY - i.top
                }
            } else n = t.clientX - i.left, r = t.clientY - i.top, this.pointerPos = {
                x: n,
                y: r
            }, this._pointerPositions = [{
                x: n,
                y: r,
                id: I._getFirstPointerId(t)
            ...
            I.warn('Method _setPointerPosition is deprecated. Use "stage.setPointersPositions(event)" instead.'), this.setPointersPositions(t)
            ...
            if (this.bufferCanvas = new G, this.bufferHitCanvas = new R({
                    pixelRatio: 1
                }), O.isBrowser) {
            ...
            return I.warn("Cache function is not allowed for stage. You may use cache only for layers, groups and shapes."), this
    ...
    At.prototype.nodeType = "Stage", i(At), b.addGetterSetter(At, "container");
    var Gt = function (i) {
        function t(t) {
            var e = i.call(this, t) || this;
            return e.canvas = new G, e._waitingForDraw = !1, e.on("visibleChange", e._checkVisibility), e._checkVisibility(), e.on("imageSmoothingEnabledChange", e._checkSmooth), e._checkSmooth(), e
        }
        return w(t, i), t.prototype.createPNGStream = function () {
            ...
            if (!$.prototype.moveUp.call(this)) return !1;
            var t = this.getStage();
            return !!t && (t.content.removeChild(this.getCanvas()._canvas), this.index < t.getChildren().length - 1 ? t.content.insertBefore(this.getCanvas()._canvas, t.getChildren()[this.index + 1].getCanvas()._canvas) : t.content.appendChild(this.getCanvas()._canvas), !0)
        }, t.prototype.moveDown = function () {
            if ($.prototype.moveDown.call(this)) {
                var t = this.getStage();
                if (t) {
                    var e = t.getChildren();
            ...
            if ($.prototype.moveToBottom.call(this)) {
                var t = this.getStage();
                if (t) {
                    var e = t.getChildren();
            ...
            return this
        }, t.prototype.hitGraphEnabled = function () {
            return !0
        }, t.prototype.remove = function () {
            var t = this.getCanvas()._canvas;
            return $.prototype.remove.call(this), t && t.parentNode && I._isInDocument(t) && t.parentNode.removeChild(t), this
        }, t.prototype.getStage = function () {
            return this.parent
            ...
            return (t = t || {}).width = t.width || this.getWidth(), t.height = t.height || this.getHeight(), t.x = void 0 !== t.x ? t.x : this.x(), t.y = void 0 !== t.y ? t.y : this.y(), $.prototype._toKonvaCanvas.call(this, t)
        }, t.prototype._checkVisibility = function () {
            var t = this.visible();
            this.canvas._canvas.style.display = t ? "block" : "none"
        }, t.prototype._checkSmooth = function () {
            this.getContext()._context.imageSmoothingEnabled = this.imageSmoothingEnabled()
        }, t.prototype.getWidth = function () {
            if (this.parent) return this.parent.width()
        }, t.prototype.setWidth = function () {
            I.warn('Can not change width of layer. Use "stage.width(value)" function instead.')
        }, t.prototype.getHeight = function () {
            if (this.parent) return this.parent.height()
        }, t.prototype.setHeight = function () {
            I.warn('Can not change height of layer. Use "stage.height(value)" function instead.')
        }, t.prototype.getIntersection = function (t, e) {
            return null
        }, t.prototype.batchDraw = function () {
            var t = this;
            return this._waitingForDraw || (this._waitingForDraw = !0, I.requestAnimFrame(function () {
    ...
    Gt.prototype.nodeType = "BaseLayer", b.addGetterSetter(Gt, "imageSmoothingEnabled", !0), b.addGetterSetter(Gt, "clearBeforeDraw", !0), a.mapMethods(Gt);
    var Rt, Lt = "hasShadow",
        Ot = "shadowRGBA",
        It = "patternImage",
        Dt = "linearGradient",
    ...
    function Ft() {
        return Rt || (Rt = I.createCanvasElement().getContext("2d"))
    }
    var Bt = {};
    ...
    var Xt = function (n) {
        ...
        return w(t, n), t.prototype.getContext = function () {
            ...
            return this._getCache(It, this.__getFillPattern)
        }, t.prototype.__getFillPattern = function () {
            if (this.fillPatternImage()) return Ft().createPattern(this.fillPatternImage(), this.fillPatternRepeat() || "repeat")
        }, t.prototype._getLinearGradient = function () {
            return this._getCache(Dt, this.__getLinearGradient)
        }, t.prototype.__getLinearGradient = function () {
            var t = this.fillLinearGradientColorStops();
            if (t) {
                for (var e = Ft(), i = this.fillLinearGradientStartPoint(), n = this.fillLinearGradientEndPoint(), r = e.createLinearGradient(i.x, i.y, n.x, n.y), o = 0; o < t.length; o += 2) r.addColorStop(t[o], t[o + 1]);
                return r
            }
        }, t.prototype._getRadialGradient = function () {
            return this._getCache(Et, this.__getRadialGradient)
        }, t.prototype.__getRadialGradient = function () {
            var t = this.fillRadialGradientColorStops();
            if (t) {
                for (var e = Ft(), i = this.fillRadialGradientStartPoint(), n = this.fillRadialGradientEndPoint(), r = e.createRadialGradient(i.x, i.y, this.fillRadialGradientStartRadius(), n.x, n.y, this.fillRadialGradientEndRadius()), o = 0; o < t.length; o += 2) r.addColorStop(t[o], t[o + 1]);
                return r
            }
            ...
            if (this.hasShadow()) {
                var t = I.colorToRGBA(this.shadowColor());
            ...
            return $.prototype.destroy.call(this), delete Bt[this.colorKey], delete this.colorKey, this
            ...
            var n = this.getLayer(),
                ...
                h = s && s.hit;
            if (this.colorKey || (console.log(this), I.warn("Looks like your canvas has a destroyed shape in it. Do not reuse shape after you destroyed it. See the shape in logs above. If you want to reuse shape you should call remove() instead of destroy()")), !this.shouldDrawHit() && !i) return this;
            ...
            try {
                for (n = (i = (e = l.getImageData(0, 0, d, c)).data).length, r = I._hexToRgb(this.colorKey), o = 0; o < n; o += 4) t < i[o + 3] ? (i[o] = r.r, i[o + 1] = r.g, i[o + 2] = r.b, i[o + 3] = 255) : i[o + 3] = 0;
                l.putImageData(e, 0, 0)
            } catch (t) {
                I.error("Unable to draw hit graph from cached scene canvas. " + t.message)
            }
            return this
        }, t.prototype.hasPointerCapture = function (t) {
            return rt(t, this)
    ...
    var jt = [{
        ...
        qt = function (n) {
            function t() {
                ...
                return t.hitCanvas = new R({
                    pixelRatio: 1
                }), t
            }
            return w(t, n), t.prototype._setCanvasSize = function (t, e) {
                this.canvas.setSize(t, e), this.hitCanvas.setSize(t, e), this._checkSmooth()
            }, t.prototype._validateAdd = function (t) {
                var e = t.getType();
                "Group" !== e && "Shape" !== e && I.throw("You may only add groups and shapes to a layer.")
            }, t.prototype.getIntersection = function (t, e) {
                var i, n, r, o;
                if (!this.hitGraphEnabled() || !this.isVisible()) return null;
                for (var a = 1, s = !1;;) {
                    for (n = 0; n < Ut; n++) {
                        if (r = jt[n], (o = (i = this._getIntersection({
                                x: t.x + r.x * a,
                                y: t.y + r.y * a
                ...
                var e, i, n = this.hitCanvas.pixelRatio,
                    ...
                    o = r[3];
                return 255 === o ? (e = I._rgbToHex(r[0], r[1], r[2]), (i = Bt["#" + e]) ? {
                    shape: i
                } : {
                    antialiased: !0
                }) : 0 < o ? {
                ...
                return this._fire("beforeDraw", {
                    node: this
                }), this.clearBeforeDraw() && n.getContext().clear(), tt.prototype.drawScene.call(this, n, e), this._fire("draw", {
                    node: this
                }), this
            }, t.prototype.drawHit = function (t, e) {
                var i = this.getLayer(),
                    n = t || i && i.hitCanvas;
                return i && i.clearBeforeDraw() && i.getHitCanvas().getContext().clear(), tt.prototype.drawHit.call(this, n, e), this
            }, t.prototype.clear = function (t) {
                return Gt.prototype.clear.call(this, t), this.getHitCanvas().getContext().clear(t), this
    ...
    qt.prototype.nodeType = "Layer", i(qt), b.addGetterSetter(qt, "hitGraphEnabled", !0, m()), a.mapMethods(qt);
    var Vt = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
        return w(e, t), e.prototype._validateAdd = function (t) {
            "Shape" !== t.getType() && I.throw("You may only add shapes to a fast layer.")
            ...
            var e = this.getLayer(),
                i = t || e && e.getCanvas();
            return this.clearBeforeDraw() && i.getContext().clear(), tt.prototype.drawScene.call(this, i), this
        }, e.prototype.draw = function () {
            return this.drawScene(), this
        }, e
    }(Gt);
    Vt.prototype.nodeType = "FastLayer", i(Vt), a.mapMethods(Vt);
    var Kt = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
        return w(e, t), e.prototype._validateAdd = function (t) {
            var e = t.getType();
            "Group" !== e && "Shape" !== e && I.throw("You may only add groups and shapes to groups.")
        }, e
    }(tt);
    Kt.prototype.nodeType = "Group", i(Kt), a.mapMethods(Kt);
    var Qt = n.performance && n.performance.now ? function () {
        ...
        Jt = function () {
            function n(t, e) {
                this.id = n.animIdCounter++, this.frame = {
                    time: 0,
                    timeDiff: 0,
                    lastTime: Qt(),
                    frameRate: 0
            ...
            return n.prototype.setLayers = function (t) {
                ...
                var t, e = n.animations,
                    i = e.length;
                for (t = 0; t < i; t++)
                    if (e[t].id === this.id) return !0;
                return !1
            }, n.prototype.start = function () {
                return this.stop(), this.frame.timeDiff = 0, this.frame.lastTime = Qt(), n._addAnimation(this), this
            }, n.prototype.stop = function () {
                return n._removeAnimation(this), this
                ...
                for (n = 0; n < l.length; n++)
                    if (e = (t = l[n]).layers, i = t.func, t._updateFrameObject(Qt()), o = e.length, !i || !1 !== i.call(t, t.frame))
            ...
            }, n.animations = [], n.animIdCounter = 0, n.animRunning = !1, n
        }(),
        Zt = {
            node: 1,
            duration: 1,
        ...
        ie = function () {
            function u(t) {
                var e, i, n = this,
                    r = t.node,
                    o = r._id,
                    a = t.easing || ne.Linear,
                    s = !!t.yoyo;
                e = void 0 === t.duration ? .3 : 0 === t.duration ? .001 : t.duration, this.node = r, this._id = $t++;
                var h = r.getLayer() || (r instanceof O.Stage ? r.getLayers() : null);
                for (i in h || I.error("Tween constructor have `node` that is not in a layer. Please add node into layer first."), this.anim = new Jt(function () {
                        n.tween.onEnterFrame()
                    }, h), this.tween = new ee(i, function (t) {
                        n._tweenFunc(t)
                    }, a, 0, 1, 1e3 * e, s), this._addListeners(), u.attrs[o] || (u.attrs[o] = {}), u.attrs[o][this._id] || (u.attrs[o][this._id] = {}), u.tweens[o] || (u.tweens[o] = {}), t) void 0 === Zt[i] && this._addAttr(i, t[i]);
            ...
            return u.prototype._addAttr = function (t, e) {
                var i, n, r, o, a, s, h, l, d = this.node,
                    c = d._id;
                if ((r = u.tweens[c][t]) && delete u.attrs[c][r][t], i = d.getAttr(t), I._isArray(e))
                    if (n = [], a = Math.max(e.length, i.length), "points" === t && e.length !== i.length && (e.length > i.length ? (h = i, i = I._prepareArrayForTween(i, e, d.closed())) : (s = e, e = I._prepareArrayForTween(e, i, d.closed()))), 0 === t.indexOf("fill"))
                        for (o = 0; o < a; o++)
                            if (o % 2 == 0) n.push(e[o] - i[o]);
                            else {
                                var p = I.colorToRGBA(i[o]);
                                l = I.colorToRGBA(e[o]), i[o] = p, n.push({
                                    r: l.r - p.r,
                                    g: l.g - p.g,
                                    b: l.b - p.b,
                                    a: l.a - p.a
                ...
                else n = -1 !== te.indexOf(t) ? (i = I.colorToRGBA(i), {
                    r: (l = I.colorToRGBA(e)).r - i.r,
                    g: l.g - i.g,
                    b: l.b - i.b,
                    a: l.a - i.a
                }) : e - i;
                u.attrs[c][this._id][t] = {
                    start: i,
                    diff: n,
                    end: e,
                    trueEnd: s,
                    trueStart: h
                }, u.tweens[c][t] = this._id
            }, u.prototype._tweenFunc = function (t) {
                var e, i, n, r, o, a, s, h, l = this.node,
                    d = u.attrs[l._id][this._id];
                for (e in d) {
                    if (n = (i = d[e]).start, r = i.diff, h = i.end, I._isArray(n))
                    ...
                    else o = -1 !== te.indexOf(e) ? "rgba(" + Math.round(n.r + r.r * t) + "," + Math.round(n.g + r.g * t) + "," + Math.round(n.b + r.b * t) + "," + (n.a + r.a * t) + ")" : n + r * t;
                    l.setAttr(e, o)
                }
                ...
                var t, e = this.node._id,
                    i = this._id,
                    n = u.tweens[e];
                for (t in this.pause(), n) delete u.tweens[e][t];
                delete u.attrs[e][i]
            }, u.attrs = {}, u.tweens = {}, u
        }();
    ...
    var ne = {
            ...
            BounceEaseIn: function (t, e, i, n) {
                return i - ne.BounceEaseOut(n - t, 0, i, n) + e
            },
            BounceEaseInOut: function (t, e, i, n) {
                return t < n / 2 ? .5 * ne.BounceEaseIn(2 * t, 0, i, n) + e : .5 * ne.BounceEaseOut(2 * t - n, 0, i, n) + .5 * i + e
            },
        ...
        oe = function (t) {
            ...
            return w(e, t), e.prototype._sceneFunc = function (t) {
    ...
    oe.prototype._centroid = !0, oe.prototype.className = "Arc", oe.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"], i(oe), b.addGetterSetter(oe, "innerRadius", 0, g()), b.addGetterSetter(oe, "outerRadius", 0, g()), b.addGetterSetter(oe, "angle", 0, g()), b.addGetterSetter(oe, "clockwise", !1, m()), a.mapMethods(oe);
    var ae = function (i) {
        function t(t) {
            var e = i.call(this, t) || this;
        ...
        return w(t, i), t.prototype._sceneFunc = function (t) {
            ...
            return this.closed() ? this._getTensionPointsClosed() : I._expandPoints(this.points(), this.tension())
        }, t.prototype._getTensionPointsClosed = function () {
            var t = this.points(),
                e = t.length,
                i = this.tension(),
                n = I._getControlPoints(t[e - 2], t[e - 1], t[0], t[1], t[2], t[3], i),
                r = I._getControlPoints(t[e - 4], t[e - 3], t[e - 2], t[e - 1], t[0], t[1], i),
                o = I._expandPoints(t, i);
            ...
            for (var t, e, i, n = (t = 0 !== this.tension() ? this._getTensionPoints() : this.points())[0], r = t[0], o = t[1], a = t[1], s = 0; s < t.length / 2; s++) e = t[2 * s], i = t[2 * s + 1], n = Math.min(n, e), r = Math.max(r, e), o = Math.min(o, i), a = Math.max(a, i);
            return {
                x: Math.round(n),
                y: Math.round(o),
    ...
    ae.prototype.className = "Line", ae.prototype._attrsAffectingSize = ["points", "bezier", "tension"], i(ae), b.addGetterSetter(ae, "closed", !1), b.addGetterSetter(ae, "bezier", !1), b.addGetterSetter(ae, "tension", 0, g()), b.addGetterSetter(ae, "points", [], function () {
        if (O.isUnminified) return function (t, e) {
            return I._isArray(t) ? t.forEach(function (t) {
                I._isNumber(t) || I.warn('"' + e + '" attribute has non numeric element ' + t + ". Make sure that all elements are numbers.")
            }) : I.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a array of numbers.'), t
        }
    }()), a.mapMethods(ae);
    var se = function (p) {
        function t() {
        ...
        return w(t, p), t.prototype._sceneFunc = function (t) {
            ...
            var o, a, s = i.length;
            a = r ? (o = i[s - 2] - n[s - 2], i[s - 1] - n[s - 1]) : (o = i[s - 2] - i[s - 4], i[s - 1] - i[s - 3]);
    ...
    se.prototype.className = "Arrow", i(se), b.addGetterSetter(se, "pointerLength", 10, g()), b.addGetterSetter(se, "pointerWidth", 10, g()), b.addGetterSetter(se, "pointerAtBeginning", !1), a.mapMethods(se);
    var he = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    he.prototype._centroid = !0, he.prototype.className = "Circle", he.prototype._attrsAffectingSize = ["radius"], i(he), b.addGetterSetter(he, "radius", 0, g()), a.mapMethods(he);
    var le = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    le.prototype.className = "Ellipse", le.prototype._centroid = !0, le.prototype._attrsAffectingSize = ["radiusX", "radiusY"], i(le), b.addComponentsGetterSetter(le, "radius", ["x", "y"]), b.addGetterSetter(le, "radiusX", 0, g()), b.addGetterSetter(le, "radiusY", 0, g()), a.mapMethods(le);
    var de = function (t) {
        function n() {
            return null !== t && t.apply(this, arguments) || this
        }
        return w(n, t), n.prototype._useBufferCanvas = function () {
    ...
    de.prototype.className = "Image", i(de), b.addGetterSetter(de, "image"), b.addComponentsGetterSetter(de, "crop", ["x", "y", "width", "height"]), b.addGetterSetter(de, "cropX", 0, g()), b.addGetterSetter(de, "cropY", 0, g()), b.addGetterSetter(de, "cropWidth", 0, g()), b.addGetterSetter(de, "cropHeight", 0, g()), a.mapMethods(de);
    var ce = ["fontFamily", "fontSize", "fontStyle", "padding", "lineHeight", "text", "width"],
        pe = "right",
        ue = "down",
        fe = "left",
        ge = ce.length,
        ve = function (i) {
            ...
            return w(t, i), t.prototype.getText = function () {
                ...
                for (e = 0; e < ge; e++) t.on(ce[e] + "Change.konva", n)
            }, t.prototype.getWidth = function () {
    ...
    ve.prototype.className = "Label", i(ve), a.mapMethods(ve);
    var ye = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
        return w(e, t), e.prototype._sceneFunc = function (t) {
            ...
            var t = 0,
                ...
                o = this.width(),
                a = this.height();
            return "up" === r ? (e -= n, a += n) : r === ue ? a += n : r === fe ? (t -= 1.5 * i, o += i) : r === pe && (o += 1.5 * i), {
                x: t,
                y: e,
                width: o,
                height: a
    ...
    ye.prototype.className = "Tag", i(ye), b.addGetterSetter(ye, "pointerDirection", "none"), b.addGetterSetter(ye, "pointerWidth", 0, g()), b.addGetterSetter(ye, "pointerHeight", 0, g()), b.addGetterSetter(ye, "cornerRadius", 0, g()), a.mapMethods(ye);
    var me = function (n) {
        function u(t) {
            var e = n.call(this, t) || this;
            e.dataArray = [], e.pathLength = 0, e.dataArray = u.parsePathData(e.data());
        ...
        return w(u, n), u.prototype._sceneFunc = function (t) {
                ...
                switch (n) {
                    ...
                    case "A":
                        var o = r[0],
                            ...
                            f = h < s ? 1 : s / h,
                            g = h < s ? h / s : 1;
                        t.translate(o, a), t.rotate(c), t.scale(f, g), t.arc(0, 0, u, l, l + d, 1 - p), t.scale(1 / f, 1 / g), t.rotate(-c), t.translate(-o, -a);
                        break;
                    case "z":
                        t.closePath()
                }
            ...
            for (var t, i, n = e[0], r = e[0], o = e[1], a = e[1], s = 0; s < e.length / 2; s++) t = e[2 * s], i = e[2 * s + 1], isNaN(t) || (n = Math.min(n, t), r = Math.max(r, t)), isNaN(i) || (o = Math.min(o, i), a = Math.max(a, i));
            return {
                x: Math.round(n),
                y: Math.round(o),
                width: Math.round(r - n),
            ...
            switch (r.command) {
                case "L":
                    return u.getPointOnLine(t, r.start.x, r.start.y, o[0], o[1]);
                case "C":
                    return u.getPointOnCubicBezier(t / r.pathLength, r.start.x, r.start.y, o[0], o[1], o[2], o[3], o[4], o[5]);
                case "Q":
                    return u.getPointOnQuadraticBezier(t / r.pathLength, r.start.x, r.start.y, o[0], o[1], o[2], o[3]);
                case "A":
                    var a = o[0],
                        s = o[1],
                        h = o[2],
                        ...
                        c = o[5],
                        p = o[6];
                    return d += c * t / r.pathLength, u.getPointOnEllipticalArc(a, s, h, l, d, p)
            }
            return null
        }, u.getLineLength = function (t, e, i, n) {
            return Math.sqrt((i - t) * (i - t) + (n - e) * (n - e))
        }, u.getPointOnLine = function (t, e, i, n, r, o, a) {
            ...
            return l
        }, u.getPointOnCubicBezier = function (t, e, i, n, r, o, a, s, h) {
            function l(t) {
                return t * t * t
            }
        ...
        }, u.getPointOnQuadraticBezier = function (t, e, i, n, r, o, a) {
            function s(t) {
                return t * t
            }
        ...
        }, u.getPointOnEllipticalArc = function (t, e, i, n, r, o) {
            var a = Math.cos(o),
                s = Math.sin(o),
                h = i * Math.cos(r),
                l = n * Math.sin(r);
            ...
            for (n = 1; n < o.length; n++) {
                ...
                for (; 0 < u.length && !isNaN(u[0]);) {
                    ...
                    switch (p) {
                        case "l":
                            h += u.shift(), l += u.shift(), T = "L", M.push(h, l);
                            break;
                        case "L":
                            h = u.shift(), l = u.shift(), M.push(h, l);
                            break;
                        case "m":
                            var R = u.shift(),
                                L = u.shift();
                            if (h += R, l += L, T = "M", 2 < a.length && "z" === a[a.length - 1].command)
                                for (var O = a.length - 2; 0 <= O; O--)
                                    if ("M" === a[O].command) {
                                        h = a[O].points[0] + R, l = a[O].points[1] + L;
                                        break
                                    } M.push(h, l), p = "l";
                            break;
                        case "M":
                            h = u.shift(), l = u.shift(), T = "M", M.push(h, l), p = "L";
                            break;
                        case "h":
                            h += u.shift(), T = "L", M.push(h, l);
                            break;
                        case "H":
                            h = u.shift(), T = "L", M.push(h, l);
                            break;
                        case "v":
                            l += u.shift(), T = "L", M.push(h, l);
                            break;
                        case "V":
                            l = u.shift(), T = "L", M.push(h, l);
                            break;
                        case "C":
                            M.push(u.shift(), u.shift(), u.shift(), u.shift()), h = u.shift(), l = u.shift(), M.push(h, l);
                            break;
                        case "c":
                            M.push(h + u.shift(), l + u.shift(), h + u.shift(), l + u.shift()), h += u.shift(), l += u.shift(), T = "C", M.push(h, l);
                            break;
                        case "S":
                            m = h, _ = l, "C" === (y = a[a.length - 1]).command && (m = h + (h - y.points[2]), _ = l + (l - y.points[3])), M.push(m, _, u.shift(), u.shift()), h = u.shift(), l = u.shift(), T = "C", M.push(h, l);
                            break;
                        case "s":
                            m = h, _ = l, "C" === (y = a[a.length - 1]).command && (m = h + (h - y.points[2]), _ = l + (l - y.points[3])), M.push(m, _, h + u.shift(), l + u.shift()), h += u.shift(), l += u.shift(), T = "C", M.push(h, l);
                            break;
                        case "Q":
                            M.push(u.shift(), u.shift()), h = u.shift(), l = u.shift(), M.push(h, l);
                            break;
                        case "q":
                            M.push(h + u.shift(), l + u.shift()), h += u.shift(), l += u.shift(), T = "Q", M.push(h, l);
                            break;
                        case "T":
                            m = h, _ = l, "Q" === (y = a[a.length - 1]).command && (m = h + (h - y.points[0]), _ = l + (l - y.points[1])), h = u.shift(), l = u.shift(), T = "Q", M.push(m, _, h, l);
                            break;
                        case "t":
                            m = h, _ = l, "Q" === (y = a[a.length - 1]).command && (m = h + (h - y.points[0]), _ = l + (l - y.points[1])), h += u.shift(), l += u.shift(), T = "Q", M.push(m, _, h, l);
                            break;
                        case "A":
                            S = u.shift(), b = u.shift(), x = u.shift(), w = u.shift(), C = u.shift(), P = h, k = l, h = u.shift(), l = u.shift(), T = "A", M = this.convertEndpointToCenterParameterization(P, k, h, l, w, C, S, b, x);
                            break;
                        case "a":
                            S = u.shift(), b = u.shift(), x = u.shift(), w = u.shift(), C = u.shift(), P = h, k = l, h += u.shift(), l += u.shift(), T = "A", M = this.convertEndpointToCenterParameterization(P, k, h, l, w, C, S, b, x)
                    }
            ...
            return 0
        }, u.convertEndpointToCenterParameterization = function (t, e, i, n, r, o, a, s, h) {
            var l = h * (Math.PI / 180),
            ...
            var f = u * a * c / s,
                ...
                w = [(-1 * d - f) / a, (-1 * c - g) / s],
                C = S(x, w);
            return _(x, w) <= -1 && (C = Math.PI), 1 <= _(x, w) && (C = 0), 0 === o && 0 < C && (C -= 2 * Math.PI), 1 === o && C < 0 && (C += 2 * Math.PI), [v, y, a, s, b, C, l, o]
        }, u
    }(Xt);
    me.prototype.className = "Path", me.prototype._attrsAffectingSize = ["data"], i(me), b.addGetterSetter(me, "data"), a.mapMethods(me);
    var _e = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    _e.prototype.className = "Rect", i(_e), b.addGetterSetter(_e, "cornerRadius", 0), a.mapMethods(_e);
    var Se = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }
    ...
    Se.prototype.className = "RegularPolygon", Se.prototype._centroid = !0, Se.prototype._attrsAffectingSize = ["radius"], i(Se), b.addGetterSetter(Se, "radius", 0, g()), b.addGetterSetter(Se, "sides", 0, g()), a.mapMethods(Se);
    var be = 2 * Math.PI,
        xe = function (t) {
            function e() {
                return null !== t && t.apply(this, arguments) || this
            ...
            return w(e, t), e.prototype._sceneFunc = function (t) {
                t.beginPath(), t.arc(0, 0, this.innerRadius(), 0, be, !1), t.moveTo(this.outerRadius(), 0), t.arc(0, 0, this.outerRadius(), be, 0, !0), t.closePath(), t.fillStrokeShape(this)
            }, e.prototype.getWidth = function () {
                return 2 * this.outerRadius()
            }, e.prototype.getHeight = function () {
                return 2 * this.outerRadius()
    ...
    xe.prototype.className = "Ring", xe.prototype._centroid = !0, xe.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"], i(xe), b.addGetterSetter(xe, "innerRadius", 0, g()), b.addGetterSetter(xe, "outerRadius", 0, g()), a.mapMethods(xe);
    var we = function (i) {
        function t(t) {
            var e = i.call(this, t) || this;
            return e._updated = !0, e.anim = new Jt(function () {
                var t = e._updated;
    ...
    we.prototype.className = "Sprite", i(we), b.addGetterSetter(we, "animation"), b.addGetterSetter(we, "animations"), b.addGetterSetter(we, "frameOffsets"), b.addGetterSetter(we, "image"), b.addGetterSetter(we, "frameIndex", 0, g()), b.addGetterSetter(we, "frameRate", 17, g()), b.backCompat(we, {
        index: "frameIndex",
    ...
    Ce.prototype.className = "Star", Ce.prototype._centroid = !0, Ce.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"], i(Ce), b.addGetterSetter(Ce, "numPoints", 5, g()), b.addGetterSetter(Ce, "innerRadius", 0, g()), b.addGetterSetter(Ce, "outerRadius", 0, g()), a.mapMethods(Ce);
    var Pe, ke = "auto",
        Te = "justify",
        Me = ["fontFamily", "fontSize", "fontStyle", "fontVariant", "padding", "align", "verticalAlign", "lineHeight", "text", "width", "height", "wrap", "ellipsis", "letterSpacing"],
        Ae = Me.length;

    function Ge() {
        return Pe || (Pe = I.createCanvasElement().getContext("2d"))
    }
    var Re = function (n) {
        function t(t) {
            var e = n.call(this, function (t) {
                return (t = t || {}).fillLinearGradientColorStops || t.fillRadialGradientColorStops || t.fillPatternImage || (t.fill = t.fill || "black"), t
            }(t)) || this;
            e._partialTextX = 0;
            for (var i = e._partialTextY = 0; i < Ae; i++) e.on(Me[i] + "Change.konva", e._setTextData);
            return e._setTextData(), e
        }
        return w(t, n), t.prototype._sceneFunc = function (t) {
            ...
            for (t.setAttr("font", this._getContextFont()), t.setAttr("textBaseline", "middle"), t.setAttr("textAlign", "left"), "middle" === s ? h = (this.getHeight() - a * r - 2 * i) / 2 : "bottom" === s && (h = this.getHeight() - a * r - 2 * i), t.translate(i, h + i), e = 0; e < a; e++) {
                ...
                var _, S, b, x = o[e],
                    ...
                    C = x.width,
                    P = e !== a - 1;
                if (t.save(), "right" === l ? y += d - C - 2 * i : "center" === l && (y += (d - C - 2 * i) / 2), f && (t.save(), t.beginPath(), t.moveTo(y, v + m + Math.round(n / 2)), S = 0 === (_ = w.split(" ").length - 1), b = l === Te && P && !S ? d - 2 * i : C, t.lineTo(y + Math.round(b), v + m + Math.round(n / 2)), t.lineWidth = n / 15, t.strokeStyle = p, t.stroke(), t.restore()), g && (t.save(), t.beginPath(), t.moveTo(y, v + m), S = 0 === (_ = w.split(" ").length - 1), b = l === Te && P && !S ? d - 2 * i : C, t.lineTo(y + Math.round(b), v + m), t.lineWidth = n / 15, t.strokeStyle = p, t.stroke(), t.restore()), 0 !== c || l === Te) {
                    _ = w.split(" ").length - 1;
                    for (var k = 0; k < w.length; k++) {
                        var T = w[k];
                        " " === T && e !== a - 1 && l === Te && (y += Math.floor((d - 2 * i - C) / _)), this._partialTextX = y, this._partialTextY = v + m, this._partialText = T, t.fillStrokeShape(this), y += Math.round(this.measureSize(T).width) + c
                    }
            ...
            var e = I._isString(t) ? t : (t || "").toString();
            return this._setAttr("text", e), this
        }, t.prototype.getWidth = function () {
            return this.attrs.width === ke || void 0 === this.attrs.width ? this.getTextWidth() + 2 * this.padding() : this.attrs.width
        }, t.prototype.getHeight = function () {
            return this.attrs.height === ke || void 0 === this.attrs.height ? this.fontSize() * this.textArr.length * this.lineHeight() + 2 * this.padding() : this.attrs.height
        }, t.prototype.getTextWidth = function () {
            return this.textWidth
        }, t.prototype.getTextHeight = function () {
            return I.warn("text.getTextHeight() method is deprecated. Use text.height() - for full height and text.fontSize() - for one line height."), this.textHeight
            ...
            var e = this.letterSpacing(),
                i = t.length;
            return Ge().measureText(t).width + (i ? e * (i - 1) : 0)
            ...
            var t = this.text().split("\n"),
                ...
                f = "char" !== p && u,
                g = this.ellipsis() && !u;
            this.textArr = [], Ge().font = this._getContextFont();
            for (var v = g ? this._getTextWidth("…") : 0, y = 0, m = t.length; y < m; ++y) {
                ...
                if (a && l < S)
                    for (; 0 < _.length;) {
                        ...
                        if (f) {
                            var M, A = _[w.length];
                            0 < (M = (" " === A || "-" === A) && C <= l ? w.length : Math.max(w.lastIndexOf(" "), w.lastIndexOf("-")) + 1) && (b = M, w = w.slice(0, b), C = this._getTextWidth(w))
                        }
    ...
    var Ie = function (i) {
        function t(t) {
            var e = i.call(this, t) || this;
            return e.dummyCanvas = I.createCanvasElement(), e.dataArray = [], e.dataArray = me.parsePathData(e.attrs.data), e.on("dataChange.konva", function () {
                this.dataArray = me.parsePathData(this.attrs.data), this._setTextData()
            }), e.on("textChange.konva alignChange.konva letterSpacingChange.konva kerningFuncChange.konva", e._setTextData), t && t.getKerning && (I.warn('getKerning TextPath API is deprecated. Please use "kerningFunc" instead.'), e.kerningFunc(t.getKerning)), e._setTextData(), e
        }
        return w(t, i), t.prototype._sceneFunc = function (t) {
            ...
            return Re.prototype.setText.call(this, t)
        }, t.prototype._getContextFont = function () {
            return Re.prototype._getContextFont.call(this)
            ...
            for (var f, g, v, r = this.text().split(""), y = this.text().split(" ").length - 1, o = -1, m = 0, _ = function () {
                    ...
                    for (g = void 0; .01 < Math.abs(e - i) / e && n < 25;) {
                        ...
                        switch (v.command) {
                            case "L":
                                me.getLineLength(f.x, f.y, v.points[0], v.points[1]) > e ? g = me.getPointOnLine(e, f.x, f.y, v.points[0], v.points[1], f.x, f.y) : v = void 0;
                                break;
                            case "A":
                                var a = v.points[4],
                                    s = v.points[5],
                                    h = v.points[4] + s;
                                0 === m ? m = a + 1e-8 : i < e ? m += Math.PI / 180 * s / Math.abs(s) : m -= Math.PI / 360 * s / Math.abs(s), (s < 0 && m < h || 0 <= s && h < m) && (m = h, o = !0), g = me.getPointOnEllipticalArc(v.points[0], v.points[1], v.points[2], v.points[3], m, v.points[6]);
                                break;
                            case "C":
                                0 === m ? m = e > v.pathLength ? 1e-8 : e / v.pathLength : i < e ? m += (e - i) / v.pathLength : m -= (i - e) / v.pathLength, 1 < m && (m = 1, o = !0), g = me.getPointOnCubicBezier(m, v.start.x, v.start.y, v.points[0], v.points[1], v.points[2], v.points[3], v.points[4], v.points[5]);
                                break;
                            case "Q":
                                0 === m ? m = e / v.pathLength : i < e ? m += (e - i) / v.pathLength : m -= (i - e) / v.pathLength, 1 < m && (m = 1, o = !0), g = me.getPointOnQuadraticBezier(m, v.start.x, v.start.y, v.points[0], v.points[1], v.points[2], v.points[3])
                        }
                        void 0 !== g && (i = me.getLineLength(f.x, f.y, g.x, g.y)), o && (o = !1, v = void 0)
                    }
                }, s = l._getTextSize("C").width + d, h = 0; h < n / s && (a("C"), void 0 !== f && void 0 !== g); h++) f = g;
            for (var S = 0; S < r.length && (a(r[S]), void 0 !== f && void 0 !== g); S++) {
                var b = me.getLineLength(f.x, f.y, g.x, g.y),
                    x = 0;
                if (e) try {
                ...
                var w = me.getPointOnLine(x + b / 2, f.x, f.y, g.x, g.y),
            ...
            for (var t, i, n = e[0], r = e[0], o = e[0], a = e[0], s = 0; s < e.length / 2; s++) t = e[2 * s], i = e[2 * s + 1], n = Math.min(n, t), r = Math.max(r, t), o = Math.min(o, i), a = Math.max(a, i);
            var h = this.fontSize();
            return {
                x: Math.round(n) - h / 2,
                y: Math.round(o) - h / 2,
    ...
    Ie.prototype._fillFunc = Le, Ie.prototype._strokeFunc = Oe, Ie.prototype._fillFuncHit = Le, Ie.prototype._strokeFuncHit = Oe, Ie.prototype.className = "TextPath", Ie.prototype._attrsAffectingSize = ["text", "fontSize", "data"], i(Ie), b.addGetterSetter(Ie, "data"), b.addGetterSetter(Ie, "fontFamily", "Arial"), b.addGetterSetter(Ie, "fontSize", 12, g()), b.addGetterSetter(Ie, "fontStyle", "normal"), b.addGetterSetter(Ie, "align", "left"), b.addGetterSetter(Ie, "letterSpacing", 0, g()), b.addGetterSetter(Ie, "textBaseline", "middle"), b.addGetterSetter(Ie, "fontVariant", "normal"), b.addGetterSetter(Ie, "text", ""), b.addGetterSetter(Ie, "textDecoration", null), b.addGetterSetter(Ie, "kerningFunc", null), a.mapMethods(Ie);
    var De = ["resizeEnabledChange", "rotateAnchorOffsetChange", "rotateEnabledChange", "enabledAnchorsChange", "anchorSizeChange", "borderEnabledChange", "borderStrokeChange", "borderStrokeWidthChange", "borderDashChange", "anchorStrokeChange", "anchorStrokeWidthChange", "anchorFillChange", "anchorCornerRadiusChange", "ignoreStrokeChange"].join(" "),
        Ee = "nodeRect",
        Fe = ["widthChange.tr", "heightChange.tr", "scaleXChange.tr", "scaleYChange.tr", "skewXChange.tr", "skewYChange.tr", "rotationChange.tr", "offsetXChange.tr", "offsetYChange.tr", "transformsEnabledChange.tr", "strokeWidthChange.tr"].join(" "),
        Be = {
            "top-left": -45,
            "top-center": 0,
            "top-right": 45,
    ...
    var ze = ["top-left", "top-center", "top-right", "middle-right", "middle-left", "bottom-left", "bottom-center", "bottom-right"],
        We = function (i) {
            function t(t) {
                var e = i.call(this, t) || this;
                return e._transforming = !1, e._createElements(), e._handleMouseMove = e._handleMouseMove.bind(e), e._handleMouseUp = e._handleMouseUp.bind(e), e.update = e.update.bind(e), e.on(De, e.update), e.getNode() && e.update(), e
            }
            return w(t, i), t.prototype.attachTo = function (t) {
                ...
                return t.on(i, n), t.on(Fe, n), t.on("xChange.tr yChange.tr", function () {
                    return e._resetTransformCache()
                }), !!this.findOne(".top-left") && this.update(), this
            }, t.prototype.getNode = function () {
                return this._node
            }, t.prototype.detach = function () {
                this.getNode() && (this.getNode().off(".tr"), this._node = void 0), this._resetTransformCache()
            }, t.prototype._resetTransformCache = function () {
                this._clearCache(Ee), this._clearCache("transform"), this._clearSelfAndDescendantCache("absoluteTransform")
            }, t.prototype._getNodeRect = function () {
                return this._getCache(Ee, this.__getNodeRect)
                ...
                t.parent && this.parent && t.parent !== this.parent && I.warn("Transformer and attached node have different parents. Konva does not support such case right now. Please move Transformer to the parent of attaching node.");
                var e = t.getClientRect({
                        skipTransform: !0,
                        skipShadow: !0,
                ...
                this._createBack(), ze.forEach(function (t) {
                    this._createAnchor(t)
                }.bind(this)), this._createAnchor("rotater")
            }, t.prototype._createAnchor = function (r) {
                var o = this,
                    a = new _e({
                ...
                var t = new Xt({
                    ...
                    sceneFunc: function (t) {
                        var e = this.getParent(),
                            i = e.padding();
                        t.beginPath(), t.rect(-i, -i, this.width() + 2 * i, this.height() + 2 * i), t.moveTo(this.width() / 2, -i), e.rotateEnabled() && t.lineTo(this.width() / 2, -e.rotateAnchorOffset() * I._sign(this.height())), t.fillStrokeShape(this)
                    }
                });
                this.add(t)
                ...
                var e, i, n, r = this.findOne("." + this.movingResizer),
                    o = r.getStage().getContent().getBoundingClientRect(),
                    a = o.left,
                    s = o.top,
                    h = {
                        x: (void 0 !== t.clientX ? t.clientX : t.touches[0].clientX) - a,
                ...
                if ("top-left" === this.movingResizer) {
                    if (l) {
                        n = Math.sqrt(Math.pow(this.findOne(".bottom-right").x() - r.x(), 2) + Math.pow(this.findOne(".bottom-right").y() - r.y(), 2));
                        var d = this.findOne(".top-left").x() > this.findOne(".bottom-right").x() ? -1 : 1;
                        e = n * this.cos * d, i = n * this.sin * d, this.findOne(".top-left").x(this.findOne(".bottom-right").x() - e), this.findOne(".top-left").y(this.findOne(".bottom-right").y() - i)
                    }
                } else if ("top-center" === this.movingResizer) this.findOne(".top-left").y(r.y());
                else if ("top-right" === this.movingResizer) {
                    if (l) {
                        n = Math.sqrt(Math.pow(this.findOne(".bottom-left").x() - r.x(), 2) + Math.pow(this.findOne(".bottom-left").y() - r.y(), 2));
                        d = this.findOne(".top-right").x() < this.findOne(".top-left").x() ? -1 : 1;
                        e = n * this.cos * d, i = n * this.sin * d, this.findOne(".top-right").x(e), this.findOne(".top-right").y(this.findOne(".bottom-left").y() - i)
                    }
                    var c = r.position();
                    this.findOne(".top-left").y(c.y), this.findOne(".bottom-right").x(c.x)
                } else if ("middle-left" === this.movingResizer) this.findOne(".top-left").x(r.x());
                else if ("middle-right" === this.movingResizer) this.findOne(".bottom-right").x(r.x());
                else if ("bottom-left" === this.movingResizer) {
                    if (l) {
                        n = Math.sqrt(Math.pow(this.findOne(".top-right").x() - r.x(), 2) + Math.pow(this.findOne(".top-right").y() - r.y(), 2));
                        d = this.findOne(".top-right").x() < this.findOne(".bottom-left").x() ? -1 : 1;
                        e = n * this.cos * d, i = n * this.sin * d, this.findOne(".bottom-left").x(this.findOne(".top-right").x() - e), this.findOne(".bottom-left").y(i)
                    }
                    c = r.position(), this.findOne(".top-left").x(c.x), this.findOne(".bottom-right").y(c.y)
                } else if ("bottom-center" === this.movingResizer) this.findOne(".bottom-right").y(r.y());
                else if ("bottom-right" === this.movingResizer) {
                    if (l) {
                        n = Math.sqrt(Math.pow(this.findOne(".bottom-right").x(), 2) + Math.pow(this.findOne(".bottom-right").y(), 2));
                        d = this.findOne(".top-left").x() > this.findOne(".bottom-right").x() ? -1 : 1;
                        e = n * this.cos * d, i = n * this.sin * d, this.findOne(".bottom-right").x(e), this.findOne(".bottom-right").y(i)
                    }
                } else if ("rotater" === this.movingResizer) {
                    var p = this.padding(),
                        u = this._getNodeRect();
                    e = r.x() - u.width / 2, i = -r.y() + u.height / 2;
                    var f = Math.atan2(-i, e) + Math.PI / 2;
                    u.height < 0 && (f -= Math.PI);
                    for (var g = O.getAngle(this.rotation()), v = I._radToDeg(g) + I._radToDeg(f), y = O.getAngle(this.getNode().rotation()), m = I._degToRad(v), _ = this.rotationSnaps(), S = 0; S < _.length; S++) {
                        var b = O.getAngle(_[S]);
                        Math.abs(b - I._degToRad(v)) % (2 * Math.PI) < .1 && (v = I._radToDeg(b), m = I._degToRad(v))
                    }
                    var x = p,
                        w = p;
                    this._fitNodeInto({
                        rotation: O.angleDeg ? v : I._degToRad(v),
                        x: u.x + (u.width / 2 + p) * (Math.cos(y) - Math.cos(m)) + (u.height / 2 + p) * (Math.sin(-y) - Math.sin(-m)) - (x * Math.cos(g) + w * Math.sin(-g)),
                        y: u.y + (u.height / 2 + p) * (Math.cos(y) - Math.cos(m)) + (u.width / 2 + p) * (Math.sin(y) - Math.sin(m)) - (w * Math.cos(g) + x * Math.sin(g)),
                        width: u.width + 2 * p,
                        height: u.height + 2 * p
                    }, t)
                ...
                if ("rotater" !== this.movingResizer) {
                    var C = this.findOne(".top-left").getAbsolutePosition(this.getParent());
                    if (this.centeredScaling() || t.altKey) {
                        var P = this.findOne(".top-left"),
                            k = this.findOne(".bottom-right"),
                            T = P.x(),
                            M = P.y(),
                            A = this.getWidth() - k.x(),
                            G = this.getHeight() - k.y();
                        k.move({
                            x: -T,
                            y: -M
                        }), P.move({
                            x: A,
                            y: G
                        }), C = P.getAbsolutePosition(this.getParent())
                    }
                    e = C.x, i = C.y;
                    var R = this.findOne(".bottom-right").x() - this.findOne(".top-left").x(),
                        L = this.findOne(".bottom-right").y() - this.findOne(".top-left").y();
                    this._fitNodeInto({
                        x: e + this.offsetX(),
                        y: i + this.offsetY(),
                        width: R,
                ...
                if (this._transforming) {
                    this._transforming = !1, window.removeEventListener("mousemove", this._handleMouseMove), window.removeEventListener("touchmove", this._handleMouseMove), window.removeEventListener("mouseup", this._handleMouseUp, !0), window.removeEventListener("touchend", this._handleMouseUp, !0), this._fire("transformend", {
                        evt: t
                    });
                    var e = this.getNode();
                ...
                var o = r.getClientRect({
                    ...
                    a = this.padding(),
                    s = (t.width - 2 * a) / o.width,
                    h = (t.height - 2 * a) / o.height,
                ...
                return this.getStage() && this._cursorChange && (this.getStage().content.style.cursor = ""), Kt.prototype.destroy.call(this), this.detach(), this._removeEvents(), this
            }, t.prototype.toObject = function () {
                return $.prototype.toObject.call(this)
            }, t
        }(Kt);
    We.prototype.className = "Transformer", i(We), b.addGetterSetter(We, "enabledAnchors", ze, function (t) {
        return t instanceof Array || I.warn("enabledAnchors value should be an array"), t instanceof Array && t.forEach(function (t) {
            -1 === ze.indexOf(t) && I.warn("Unknown anchor name: " + t + ". Available names are: " + ze.join(", "))
        }), t || []
    }), b.addGetterSetter(We, "resizeEnabled", !0), b.addGetterSetter(We, "anchorSize", 10, g()), b.addGetterSetter(We, "rotateEnabled", !0), b.addGetterSetter(We, "rotationSnaps", []), b.addGetterSetter(We, "rotateAnchorOffset", 50, g()), b.addGetterSetter(We, "borderEnabled", !0), b.addGetterSetter(We, "anchorStroke", "rgb(0, 161, 255)"), b.addGetterSetter(We, "anchorStrokeWidth", 1, g()), b.addGetterSetter(We, "anchorFill", "white"), b.addGetterSetter(We, "anchorCornerRadius", 0, g()), b.addGetterSetter(We, "borderStroke", "rgb(0, 161, 255)"), b.addGetterSetter(We, "borderStrokeWidth", 1, g()), b.addGetterSetter(We, "borderDash"), b.addGetterSetter(We, "keepRatio", !0), b.addGetterSetter(We, "centeredScaling", !1), b.addGetterSetter(We, "ignoreStroke", !1), b.addGetterSetter(We, "padding", 0, g()), b.addGetterSetter(We, "node"), b.addGetterSetter(We, "boundBoxFunc"), b.backCompat(We, {
    ...
    Ne.prototype.className = "Wedge", Ne.prototype._centroid = !0, Ne.prototype._attrsAffectingSize = ["radius"], i(Ne), b.addGetterSetter(Ne, "radius", 0, g()), b.addGetterSetter(Ne, "angle", 0, g()), b.addGetterSetter(Ne, "clockwise", !1), b.backCompat(Ne, {
        angleDeg: "angle",
        getAngleDeg: "getAngle",
        setAngleDeg: "setAngle"
    }), a.mapMethods(Ne);
    var Ye = [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259],
        Xe = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
    b.addGetterSetter($, "blurRadius", 0, g(), b.afterSetFilter);
    b.addGetterSetter($, "brightness", 0, g(), b.afterSetFilter);
    b.addGetterSetter($, "contrast", 0, g(), b.afterSetFilter);
    ...
    b.addGetterSetter($, "embossStrength", .5, g(), b.afterSetFilter), b.addGetterSetter($, "embossWhiteLevel", .5, g(), b.afterSetFilter), b.addGetterSetter($, "embossDirection", "top-left", null, b.afterSetFilter), b.addGetterSetter($, "embossBlend", !1, null, b.afterSetFilter);
    b.addGetterSetter($, "enhance", 0, g(), b.afterSetFilter);
    b.addGetterSetter($, "hue", 0, g(), b.afterSetFilter), b.addGetterSetter($, "saturation", 0, g(), b.afterSetFilter), b.addGetterSetter($, "luminance", 0, g(), b.afterSetFilter);
    b.addGetterSetter($, "hue", 0, g(), b.afterSetFilter), b.addGetterSetter($, "saturation", 0, g(), b.afterSetFilter), b.addGetterSetter($, "value", 0, g(), b.afterSetFilter);
    ...
    b.addGetterSetter($, "kaleidoscopePower", 2, g(), b.afterSetFilter), b.addGetterSetter($, "kaleidoscopeAngle", 0, g(), b.afterSetFilter);
    b.addGetterSetter($, "threshold", 0, g(), b.afterSetFilter);
    b.addGetterSetter($, "noise", .2, g(), b.afterSetFilter);
    b.addGetterSetter($, "pixelSize", 8, g(), b.afterSetFilter);
    b.addGetterSetter($, "levels", .5, g(), b.afterSetFilter);
    b.addGetterSetter($, "red", 0, function (t) {
        return this._filterUpToDate = !1, 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    }), b.addGetterSetter($, "green", 0, function (t) {
        return this._filterUpToDate = !1, 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    }), b.addGetterSetter($, "blue", 0, f, b.afterSetFilter);
    b.addGetterSetter($, "red", 0, function (t) {
        return this._filterUpToDate = !1, 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    }), b.addGetterSetter($, "green", 0, function (t) {
        return this._filterUpToDate = !1, 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    }), b.addGetterSetter($, "blue", 0, f, b.afterSetFilter), b.addGetterSetter($, "alpha", 1, function (t) {
        return this._filterUpToDate = !1, 1 < t ? 1 : t < 0 ? 0 : t
    });
    return b.addGetterSetter($, "threshold", .5, g(), b.afterSetFilter), re.Util._assign(re, {
        Arc: oe,
        Arrow: se,
        Circle: he,
        Ellipse: le,
        ...
        Filters: {
            Blur: function (t) {
                ...
                0 < e && function (t, e) {
                    var i, n, r, o, a, s, h, l, d, c, p, u, f, g, v, y, m, _, S, b, x, w, C, P, k = t.data,
                        ...
                        z = Ye[e],
                        W = Xe[e];
                    for (r = 1; r < A; r++) E = E.next = new He, r === L && (D = E);
                    for (E.next = I, h = s = 0, n = 0; n < M; n++) {
                        for (y = m = _ = S = l = d = c = p = 0, u = L * (b = k[s]), f = L * (x = k[s + 1]), g = L * (w = k[s + 2]), v = L * (C = k[s + 3]), l += O * b, d += O * x, c += O * w, p += O * C, E = I, r = 0; r < L; r++) E.r = b, E.g = x, E.b = w, E.a = C, E = E.next;
                        for (r = 1; r < L; r++) o = s + ((G < r ? G : r) << 2), l += (E.r = b = k[o]) * (P = L - r), d += (E.g = x = k[o + 1]) * P, c += (E.b = w = k[o + 2]) * P, p += (E.a = C = k[o + 3]) * P, y += b, m += x, _ += w, S += C, E = E.next;
                        for (F = I, B = D, i = 0; i < T; i++) k[s + 3] = C = p * z >> W, 0 !== C ? (C = 255 / C, k[s] = (l * z >> W) * C, k[s + 1] = (d * z >> W) * C, k[s + 2] = (c * z >> W) * C) : k[s] = k[s + 1] = k[s + 2] = 0, l -= u, d -= f, c -= g, p -= v, u -= F.r, f -= F.g, g -= F.b, v -= F.a, o = h + ((o = i + e + 1) < G ? o : G) << 2, l += y += F.r = k[o], d += m += F.g = k[o + 1], c += _ += F.b = k[o + 2], p += S += F.a = k[o + 3], F = F.next, u += b = B.r, f += x = B.g, g += w = B.b, v += C = B.a, y -= b, m -= x, _ -= w, S -= C, B = B.next, s += 4;
                        h += T
                    }
                    for (i = 0; i < T; i++) {
                        for (m = _ = S = y = d = c = p = l = 0, u = L * (b = k[s = i << 2]), f = L * (x = k[s + 1]), g = L * (w = k[s + 2]), v = L * (C = k[s + 3]), l += O * b, d += O * x, c += O * w, p += O * C, E = I, r = 0; r < L; r++) E.r = b, E.g = x, E.b = w, E.a = C, E = E.next;
                        for (a = T, r = 1; r <= e; r++) s = a + i << 2, l += (E.r = b = k[s]) * (P = L - r), d += (E.g = x = k[s + 1]) * P, c += (E.b = w = k[s + 2]) * P, p += (E.a = C = k[s + 3]) * P, y += b, m += x, _ += w, S += C, E = E.next, r < R && (a += T);
                        for (s = i, F = I, B = D, n = 0; n < M; n++) k[3 + (o = s << 2)] = C = p * z >> W, 0 < C ? (C = 255 / C, k[o] = (l * z >> W) * C, k[o + 1] = (d * z >> W) * C, k[o + 2] = (c * z >> W) * C) : k[o] = k[o + 1] = k[o + 2] = 0, l -= u, d -= f, c -= g, p -= v, u -= F.r, f -= F.g, g -= F.b, v -= F.a, o = i + ((o = n + L) < R ? o : R) * T << 2, l += y += F.r = k[o], d += m += F.g = k[o + 1], c += _ += F.b = k[o + 2], p += S += F.a = k[o + 3], F = F.next, u += b = B.r, f += x = B.g, g += w = B.b, v += C = B.a, y -= b, m -= x, _ -= w, S -= C, B = B.next, s += T
                    }
                }(t, e)
            },
            Brighten: function (t) {
            ...
            Emboss: function (t) {
                ...
                switch (n) {
                    ...
                    case "left":
                        ...
                        break;
                    default:
                        I.error("Unknown emboss direction: " + n)
                }
                do {
                    var p = (c - 1) * d,
                        u = o;
            ...
            Enhance: function (t) {
                ...
                if (0 !== u) {
                    ...
                    for (h === s && (h = 255, s = 0), d === l && (d = 255, l = 0), p === c && (p = 255, c = 0), x = 0 < u ? (g = h + u * (255 - h), v = s - u * (s - 0), m = d + u * (255 - d), _ = l - u * (l - 0), b = p + u * (255 - p), c - u * (c - 0)) : (g = h + u * (h - (f = .5 * (h + s))), v = s + u * (s - f), m = d + u * (d - (y = .5 * (d + l))), _ = l + u * (l - y), b = p + u * (p - (S = .5 * (p + c))), c + u * (c - S)), r = 0; r < a; r += 4) o[r + 0] = je(o[r + 0], s, h, v, g), o[r + 1] = je(o[r + 1], l, d, _, m), o[r + 2] = je(o[r + 2], c, p, x, b)
                }
            },
                ...
                if (!(p < 1)) {
                    ...
                    ! function (t, e, i) {
                        ...
                        var m, _, S, b, x = d,
                            ...
                            C = 360 / w * Math.PI / 180;
                        for (_ = 0; _ < w; _ += 1)
                            for (S = Math.sin(_ * C), b = Math.cos(_ * C), m = 0; m < x; m += 1) r = Math.floor(c + y * m / x * b), u = s[0 + (n = 4 * ((o = Math.floor(p + y * m / x * S)) * l + r))], f = s[n + 1], g = s[n + 2], v = s[n + 3], h[0 + (n = 4 * (_ + m * l))] = u, h[n + 1] = f, h[n + 2] = g, h[n + 3] = v
                    }(t, v, {
                        polarCenterX: d / 2,
                        polarCenterY: c / 2
                    });
                    ...
                    for (i = 0; i < c; i += 1)
                        for (m = Math.floor(y), n = 0; n < p; n += 1) {
                            ...
                            var S, b, x, w = p,
                                ...
                                P = i.polarRotation || 0;
                            for (r = 0; r < c; r += 1)
                                for (o = 0; o < p; o += 1) a = r - u, s = o - f, S = Math.sqrt(a * a + s * s) * w / _, b = (b = (180 * Math.atan2(s, a) / Math.PI + 360 + P) % 360) * C / 360, x = Math.floor(b), g = l[0 + (n = 4 * (Math.floor(S) * c + x))], v = l[n + 1], y = l[n + 2], m = l[n + 3], d[0 + (n = 4 * (o * c + r))] = g, d[n + 1] = v, d[n + 2] = y, d[n + 3] = m
                        }(v, t, {
                            polarRotation: 0
                        })
                }
            ...
            Mask: function (t) {
                var e = function (t, e) {
                    var i = Ue(t, 0, 0),
                        n = Ue(t, t.width - 1, 0),
                        r = Ue(t, 0, t.height - 1),
                        o = Ue(t, t.width - 1, t.height - 1),
                        a = e || 10;
                    if (qe(i, n) < a && qe(n, o) < a && qe(o, r) < a && qe(r, i) < a) {
                        for (var s = function (t) {
                            ...
                            var d = qe(s, [t.data[4 * l], t.data[4 * l + 1], t.data[4 * l + 2]]);
                            h[l] = d < a ? 0 : 255
                        }
                        return h
                    }
            ...
            Pixelate: function (t) {
                var e, i, n, r, o, a, s, h, l, d, c, p, u, f, g = Math.ceil(this.pixelSize()),
                    ...
                    _ = Math.ceil(y / g),
                    S = t.data;
                if (g <= 0) I.error("pixelSize value can not be <= 0");
                else
                    for (p = 0; p < m; p += 1)
                        for (u = 0; u < _; u += 1) {
                            for (l = (h = p * g) + g, c = (d = u * g) + g, f = s = a = o = r = 0, e = h; e < l; e += 1)
                                if (!(v <= e))
                                    for (i = d; i < c; i += 1) y <= i || (r += S[0 + (n = 4 * (v * i + e))], o += S[n + 1], a += S[n + 2], s += S[n + 3], f += 1);
                            for (r /= f, o /= f, a /= f, s /= f, e = h; e < l; e += 1)
                                if (!(v <= e))
                                    for (i = d; i < c; i += 1) y <= i || (S[0 + (n = 4 * (v * i + e))] = r, S[n + 1] = o, S[n + 2] = a, S[n + 3] = s)
                        }
            },
